...
NSString *const FMAAddItemVCDidCreateProductNotification            = @"com.xian.store.manager.addItemVCDidCreateProductNotification";
NSString *const FMACreateItemVCDidUploadProductImagesNotification   = @"com.xian.store.manager.createItemVCDidUploadProductImagesNotification";
NSString *const FMABackgroundSettingDidUpdateNotification   = @"com.xian.store.manager.backgroundSettingDidUpdateNotification";
...
NSString *const kFMASideMenuItemTitleStore          = @"Store";

...
@interface FMAPendingOrdersVC ()

@end

@implementation FMAPendingOrdersVC
{
...
{
    if (!debug || !debugFMAPendingOrdersVC) return;
...
- (void)sendRequest
{
    ...
    [FMAPendingOrdersUtil requestGetPendingOrders:[dataSource count] searchString:_searchBar.text delegate:self];
}
...
{
    [self printLogWith:@"requestGetPendingOrdersDidRespondWithOrders"];
...
// -------------------------------------------------------------------------------------------------------------------------
#pragma mark - FMAPendingOrdersCVCellDelegate
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row < [dataSource count])
    {
        ...
        FMAPendingOrdersCVCell *cell1 = (FMAPendingOrdersCVCell *)cell;

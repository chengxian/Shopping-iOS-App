...
#define CELLID_ORDERS                   @"PendingOrders2Cell"
#define CELLID_LOADMORE                 @"LoadMoreCell"

#define EMPTY_LABEL_TEXT                @"No Order(s) Found"

@interface FMAPendingOrders2VC ()

@end

@implementation FMAPendingOrders2VC
{
...
{
    if (!debug || !debugFMAPendingOrders2VC) return;
...
- (void)sendRequest
{
    ...
    [FMAPendingOrdersUtil requestGetPendingOrders:[dataSource count] searchString:@"" delegate:self];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.row < [dataSource count])
    {
        FMAPendingOrders2Cell *cell1 = (FMAPendingOrders2Cell *)cell;

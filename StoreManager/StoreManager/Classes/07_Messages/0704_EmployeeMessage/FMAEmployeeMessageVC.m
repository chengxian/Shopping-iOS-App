...
@interface FMAEmployeeMessageVC ()

@end

@implementation FMAEmployeeMessageVC
{
...
{
    if (!debug || !debugFMAEmployeeMessageVC) return;
...
- (void)sendRequest
{
    ...
    [FMAEmployeeMessageUtil requestGetMessagesInEmployeeMessagePageWithFilterParams:[dataSource count]
                                                                              other:_other
                                                                           delegate:self];
}
...
- (void)sendRequestForLatestMessages:(id)sender
{
    ...
    [FMAEmployeeMessageUtil requestGetLatestMessagesInEmployeeMessagePageWithFilterParams:lastDate other:_other delegate:self];

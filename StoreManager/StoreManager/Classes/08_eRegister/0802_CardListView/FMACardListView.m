...
@implementation FMACardListView
{
...
{
    if (!debug || !debugFMACardListView) return;
...
- (void)initDataSource
{
    ...
    _cardList = [FMAERegisterUtil cardList];
}
...
- (void)deleteCardAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [FMAERegisterUtil deleteCreditCardByIndex:indexPath.row];
...
{
    FMACardListCVCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:CELLID forIndexPath:indexPath];
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (self.bEdit)
    {
        UIAlertView *alertView = [FMAUtil okCancelAlertWithTitle:nil message:MESSAGE_CARD_DELETE OkTitle:nil CancelTitle:nil delegate:self];
